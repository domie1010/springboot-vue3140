...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			<dt onClick="changeImage()">会员信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="huiyuanxinxi_add.jsp" target="rightFrame">会员信息添加</a></dd>
			<dd><a href="huiyuanxinxiList.do" target="rightFrame">会员信息查询</a></dd>

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">球桌信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="qiuzhuoxinxi_add.jsp" target="rightFrame">球桌信息添加</a></dd>
			<dd><a href="qiuzhuoxinxiList.do" target="rightFrame">球桌信息查询</a></dd>
		</dl>
	
		<dl class="app">
			<dt onClick="changeImage()">订桌信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="dingzhuoxinxiList.do" target="rightFrame">订桌信息</a></dd>
		</dl>
	
		<dl class="cloud">
			<dt onClick="changeImage()">付费信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="fufeiList.do" target="rightFrame">付费信息查询</a></dd>
		</dl>
	
		<dl class="syetem_management">
			<dt onClick="changeImage()">活动信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="huodongxinxi_add.jsp" target="rightFrame">活动信息添加</a></dd>
			<dd><a href="huodongxinxiList.do" target="rightFrame">活动信息查询</a></dd>
		</dl>
