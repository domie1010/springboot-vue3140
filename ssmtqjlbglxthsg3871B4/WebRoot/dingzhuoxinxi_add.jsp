...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addDingzhuoxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加订桌信息</td>
						</tr>
						<tr ><td width="200">球桌号：</td><td><input name='qiuzhuohao' type='text' id='qiuzhuohao' value='' onblur='' style='border:solid 1px #000000; color:#666666'  readonly='readonly' /></td></tr><script language="javascript">document.form1.qiuzhuohao.value='<%=connDbBean.readzd("qiuzhuoxinxi","qiuzhuohao","id",request.getParameter("id"))%>';document.form1.qiuzhuohao.setAttribute("readOnly",'true');</script>
		...
		<tr ><td width="200">订桌时间：</td><td><input name='dingzhuoshijian' type='text' id='dingzhuoshijian' value='' onblur='' style='border:solid 1px #000000; color:#666666' />时间自动生成不用添加</td></tr>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var meixiaoshijifeiobj = document.getElementById("meixiaoshijifei"); if(meixiaoshijifeiobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(meixiaoshijifeiobj.value)){document.getElementById("clabelmeixiaoshijifei").innerHTML=""; }else{document.getElementById("clabelmeixiaoshijifei").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}  
