...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="fufeiList.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh}  </td>
		 ...
		 <%
			String sql="select * from fufei where 1=1 ";
...
while(RS_result.next()){
		...
		共计总金额:<%=zongjinez%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="fufeiList.do?page=1" >首页</a>
             <a href="fufeiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="fufeiList.do?page=${page.page+1 }">下一页</a>
			<a href="fufeiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
