...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="dingzhuoxinxiList.do" name="myform" method="post">
    ...
    <td>${u.zhekou}</td>
                              ...
                              <td align="center"><a href="doUpdateDingzhuoxinxi.do?id=${u.id }">编辑</a>  <a href="deleteDingzhuoxinxi.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="dingzhuoxinxiList.do?page=1" >首页</a>
             <a href="dingzhuoxinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="dingzhuoxinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="dingzhuoxinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
