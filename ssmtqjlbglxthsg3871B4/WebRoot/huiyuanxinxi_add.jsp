	...
	<body>
			<form action="addHuiyuanxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加会员信息</td>
						</tr>
...
function hsgcheck() {
		...
		if(huiyuanbianhao==""||){
			 $("#clabelhuiyuanbianhao").html("<font color=red>之间！</font>");
		...
		else
		{
			...
			$.ajax({
				...
				if(result.info=="ng"){
					$("#clabelhuiyuanbianhao").html("<font color=red>会员编号已存在，请更换！</font>");
					$("input[id=huiyuanbianhao]").focus();
					$("#querenzhuce").attr("disabled","disabled");
					return false;
				}
